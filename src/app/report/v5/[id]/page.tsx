...
import BestFitUseCases from "@/components/assessment/report/v5/BestFitUseCases";
import ROIBreakdown from "@/components/assessment/report/v5/ROIBreakdown";
import GetStartedPlan from "@/components/assessment/report/v5/GetStartedPlan";
      ...
      <header className="border-b border-bg-card-alt/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <div className="text-lg font-bold text-text-primary">V5.0</div>
          </div>
        </div>
      </header>
