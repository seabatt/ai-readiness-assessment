...
-   **Report Generation**: Generates V4 reports with high accuracy, including:
    ...
    -   **Call to Action**: CustomReportCTA with white button "Run the Full Discovery Assessment →" linking to book-a-demo, preceded by description text. Button matches app-wide styling (bg-white text-black px-8 py-4 rounded-lg).
