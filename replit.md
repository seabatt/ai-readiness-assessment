...
-   **Expand/Collapse Capability Cards**: Added interactive expand/collapse functionality to "Your AI Worker Capabilities" section. Cards start collapsed by default with clickable headers featuring rotating chevron icons. Smooth Framer Motion animations on expand/collapse. Fully keyboard accessible with proper ARIA attributes (aria-expanded, aria-label).
